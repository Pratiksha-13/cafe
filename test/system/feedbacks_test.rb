...
class FeedbacksTest < ApplicationSystemTestCase
  ...
  test "creating a Feedback" do
    ...
    fill_in "Customer name", with: @feedback.customer_name
    fill_in "Product name", with: @feedback.product_name
    fill_in "Star", with: @feedback.star
    fill_in "Suggestions", with: @feedback.suggestions
